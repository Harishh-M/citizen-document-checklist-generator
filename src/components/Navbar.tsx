...
import { ShieldCheck, FileText, Sparkles, Settings, Info, Landmark } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({ currentView, setCurrentView, systemStatus }) => {
  return (
      ...
      <div className="bg-slate-950 text-slate-400 text-xs py-1 px-4 border-b border-slate-800/80">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <span className="hidden md:inline text-slate-400">Database: <strong className="text-emerald-400 font-semibold">{systemStatus?.database?.mode || 'MySQL Store'}</strong></span>
