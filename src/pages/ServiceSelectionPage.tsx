    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="space-y-3">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 text-emerald-800 text-xs font-semibold border border-emerald-200">
          ...
          <span>Official Public Services Directory</span>
        </div>
        <h1 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
          Select Government Service
        </h1>
        <p className="text-slate-600 text-sm sm:text-base max-w-3xl">
          Choose the public service you are preparing to apply for. Our AI will guide you with a custom document checklist based on your profile circumstances.
        </p>
      </div>
      ...
      <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search by service name, keyword, or department (e.g., 'Income', 'Scholarship', 'Pension')..."
            ...
            >
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between text-xs">
                  <span className="text-slate-500 font-medium truncate max-w-[200px]" title={service.department}>
                    {service.department}
                  </span>
